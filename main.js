  ...
  splashWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      preload: app.isPackaged 
        ? path.join(process.resourcesPath, 'app.asar', 'public', 'preload.js')
        : path.join(__dirname, 'public', 'preload.js')
    },
    icon: app.isPackaged 
      ? path.join(process.resourcesPath, 'app.asar', 'assets', 'icons', 'win', 'icon.ico')
      : path.join(__dirname, 'assets', 'icons', 'win', 'icon.ico'),
    show: false
  });

  const splashPath = app.isPackaged 
    ? path.join(process.resourcesPath, 'app.asar', 'public', 'splash.html')
...
function createMainWindow() {
  ...
  if (isDev) {
    ...
    // Production modunda doğru yolu bul
